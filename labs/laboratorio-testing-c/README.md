...
> R: carrito_init inicializa el carrito, poniendo en 0 su cantidad de items. Es importante porque sino en el struct pueden haber datos residuales almacenados que alteren negativamente la ejecución del programa.
...
> R: En la línea 24. Falta multiplicar el precio de cada producto por su cantidad.

**P7** — ¿Qué debería hacer esa línea para calcular el total correctamente?

> R: Multiplicar la cantidad accediento al campo "cantidad" del struct.
...
> R: El test falla. El 5to carrito devuelve 1 cuando se esperaba 0.
...
> R: El test unitario evalúa una función en forma aislada, mientras que el de integración verifica cómo funcionan en conjunto varias funciones. El test unitario detectó primero el bug de carrito_total.
...
> R: Porque en C se tiene acceso directo a posiciones de memoria, y la prevención queda bajo responsabilidad del programador, mientras que lenguajes como Python o Java tienen mecanismos internos que no permiten acceder a posiciones de memoria fuera de los límites permitidos.
