...
> **R:**Porque son todas las líneas que se incluyeron durante la compilación, no solamente el programa fuente sino todo lo referido a las librerías incluídas al momento de la compilación
...
> **R:**Porque el archivo .i es el que se crea luego de la fase de preprocesamiento, que justamente omite todos los comentarios.
...
> **R:**Comunican todas las veces que se llamó a stdio.h. El bloque que contiene la declaración de printf justamente viene también de stdio.h
...
> **R:**Son instrucciones al procesador en lenguaje assembly. 
...
> **R:**Porque programa.c usa area_circulo, pero no es el archivo que lo declara, sino que está declarado en matematica.c
...
> **R:**Son funciones de la biblioteca dinámica del sistema que se cargan en tiempo de ejecución, por lo tanto, sin consulto fuera de la ejecución del programa, no van a estar definidas. Los resuelve el cargador dinámico durante la ejecución.
...
> **R:**Una macro función se resuelve en tiempo de preprocesamiento, es decir, el procesador reemplazará todas las ocurrencias del nombre de la función por su contenido. El compilador no las ve, sino que al momento de compilar, ya están desarrolladas.
...
> **R:**El símbolo T hace referencia a código ejecutable definido en la sección text, mientras que D son las variables globales que tienen asignado un valor inicial (distinto de 0), definidas en la sección data
